    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.ForeignKey(related_name='items', to='shop.Cart', blank=True, null=True, on_delete=models.deletion.SET_NULL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            name='Category',
            fields=[
                ('page_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True, serialize=False, to='pages.Page', blank=True, null=True, on_delete=models.deletion.SET_NULL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit_price', cartridge.shop.fields.MoneyField(decimal_places=2, default=Decimal('0'), max_digits=10, blank=True, null=True, verbose_name='Unit price')),
                ('total_price', cartridge.shop.fields.MoneyField(decimal_places=2, default=Decimal('0'), max_digits=10, blank=True, null=True, verbose_name='Total price')),
                ('order', models.ForeignKey(related_name='items', to='shop.Order', blank=True, null=True, on_delete=models.deletion.SET_NULL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(related_name='actions', to='shop.Product', blank=True, null=True, on_delete=models.deletion.SET_NULL)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(related_name='images', to='shop.Product', blank=True, null=True, on_delete=models.deletion.SET_NULL)),
            ],
            options={
                'ordering': ('_order',),
                'verbose_name': 'Image',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(verbose_name='Image', blank=True, to='shop.ProductImage', null=True, on_delete=models.deletion.SET_NULL)),
                ('product', models.ForeignKey(related_name='variations', to='shop.Product', blank=True, null=True, on_delete=models.deletion.SET_NULL)),
            ],
            options={
                'ordering': ('-default',),
            },
        ...
        migrations.AddField(
            model_name='category',
            name='sale',
            field=models.ForeignKey(verbose_name='Sale', blank=True, to='shop.Sale', null=True, on_delete=models.deletion.SET_NULL),
            preserve_default=True,
        ),
    ]
